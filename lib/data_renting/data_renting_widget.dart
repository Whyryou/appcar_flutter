...
import 'data_renting_model.dart';
export 'data_renting_model.dart';

class DataRentingWidget extends StatefulWidget {
  final FFParameters params;
  const DataRentingWidget({Key? key, required this.params}) : super(key: key);

  @override
  _DataRentingWidgetState createState() => _DataRentingWidgetState();
}

class _DataRentingWidgetState extends State<DataRentingWidget> {
  late DataRentingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DataRentingModel());
