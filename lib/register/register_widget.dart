...
class _RegisterWidgetState extends State<RegisterWidget> {
  ...
  void initState() {
    ...
    _model.nameController ??= TextEditingController(text: 'สุพิชญา');
    _model.lastnameController ??= TextEditingController(text: 'บุญเรือง');
    _model.emailAddressController ??=
        TextEditingController(text: '651513011@gmail.com');
    _model.passwordController ??= TextEditingController(text: '123456');
    _model.confirmPasswordController ??= TextEditingController(text: '123456');
  }
