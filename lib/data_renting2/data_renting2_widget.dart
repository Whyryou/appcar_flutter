...
import 'data_renting2_model.dart';
export 'data_renting2_model.dart';

class DataRenting2Widget extends StatefulWidget {
  const DataRenting2Widget({Key? key}) : super(key: key);

  @override
  _DataRenting2WidgetState createState() => _DataRenting2WidgetState();
}

class _DataRenting2WidgetState extends State<DataRenting2Widget> {
  late DataRenting2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DataRenting2Model());
  }
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(25.0, 0.0, 0.0, 0.0),
                    child: Text(
                      '2. หากยกเลิกผู้ให้บริการจะคืนเงินให้ภายใน 7 วัน',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Roboto',
                            color: Color(0xFF14181B),
                            fontSize: 18.0,
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      '3. หากยกเลิกผู้เช่าจะไม่ได้รับเงินมัดจำคืน',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Roboto',
                            color: Color(0xFF14181B),
                            fontSize: 18.0,
