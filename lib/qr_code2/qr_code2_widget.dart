...
import 'qr_code2_model.dart';
export 'qr_code2_model.dart';

class QrCode2Widget extends StatefulWidget {
  const QrCode2Widget({Key? key}) : super(key: key);
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'ยอดเงินรวมที่ต้องชำระ ${_model.formatter.format(rentSUM)} บาท',
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      '* ชำระผ่านแอปพลิเคชันทุกธนาคารฟรีค่าธรรมเนียม',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Roboto',
