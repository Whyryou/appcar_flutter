...
import 'data_check2_model.dart';
export 'data_check2_model.dart';

class DataCheck2Widget extends StatefulWidget {
  final FFParameters params;
  const DataCheck2Widget({Key? key, required this.params}) : super(key: key);

  @override
  _DataCheck2WidgetState createState() => _DataCheck2WidgetState();
}

class _DataCheck2WidgetState extends State<DataCheck2Widget> {
  late DataCheck2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DataCheck2Model());
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        10.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      '${_model.formatter.format(_model.sum - 1000)}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Roboto',
