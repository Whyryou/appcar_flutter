...
class _CancelWidgetState extends State<CancelWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CancelModel());
                            ...
                            children: [
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    15.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  '1. หลังจากยกเลิกแล้วทางผู้เช่าจะไม่ได้รับเงินมัดจำคืน',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        fontFamily: 'Roboto',
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed('data_renting');
                      },
                      child: Text(
                        'ไม่ใช่',
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
